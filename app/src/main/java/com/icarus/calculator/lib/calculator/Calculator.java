package com.icarus.calculator.lib.calculator;

import com.icarus.calculator.engine.CalculatorEngine;
import com.icarus.calculator.lib.calculator.filter.CorrectionExprFilter;
import com.icarus.calculator.lib.calculator.filter.ExprFilter;
import com.icarus.calculator.lib.calculator.filter.PinyinExprFilter;
import com.icarus.calculator.lib.calculator.parser.CalculatorEvalVisitor;
import com.icarus.calculator.lib.calculator.parser.CalculatorLatexExprVisitor;
import com.icarus.calculator.lib.calculator.parser.grammer.calculatorLexer;
 ...
 * 计算语音输入的表达式语句的结果
 */
public class Calculator implements ANTLRErrorListener, CalculatorEngine {
    /**
     * 上次计算结果
     */
    ...
    public String format(double num, int maxFloat) {
